...
public class Transaction extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2198803218635795664L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Transaction\",\"namespace\":\"com.ibm.kafka.streams.assigment\",\"fields\":[{\"name\":\"balanceId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"balance\",\"type\":\"float\"}]}");
   ...
   */
  public static com.ibm.kafka.streams.assigment.Transaction.Builder newBuilder() {
    return new com.ibm.kafka.streams.assigment.Transaction.Builder();
  }
   ...
   * @return A new Transaction RecordBuilder
   */
  public static com.ibm.kafka.streams.assigment.Transaction.Builder newBuilder(com.ibm.kafka.streams.assigment.Transaction.Builder other) {
    if (other == null) {
      return new com.ibm.kafka.streams.assigment.Transaction.Builder();
    } else {
      return new com.ibm.kafka.streams.assigment.Transaction.Builder(other);
    }
  }
   ...
   * @return A new Transaction RecordBuilder
   */
  public static com.ibm.kafka.streams.assigment.Transaction.Builder newBuilder(com.ibm.kafka.streams.assigment.Transaction other) {
    if (other == null) {
      return new com.ibm.kafka.streams.assigment.Transaction.Builder();
    } else {
      return new com.ibm.kafka.streams.assigment.Transaction.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Transaction>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ibm.kafka.streams.assigment.Transaction.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ibm.kafka.streams.assigment.Transaction other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.balanceId)) {
        this.balanceId = data().deepCopy(fields()[0].schema(), other.balanceId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.kafka.streams.assigment.Transaction.Builder setBalanceId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.kafka.streams.assigment.Transaction.Builder clearBalanceId() {
      balanceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.kafka.streams.assigment.Transaction.Builder setAccountId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.kafka.streams.assigment.Transaction.Builder clearAccountId() {
      accountId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.kafka.streams.assigment.Transaction.Builder setBalance(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.kafka.streams.assigment.Transaction.Builder clearBalance() {
