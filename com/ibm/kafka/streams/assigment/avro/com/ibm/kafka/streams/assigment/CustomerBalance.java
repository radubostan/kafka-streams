 ...
 */
package com.ibm.kafka.streams.assigment;
...
public class CustomerBalance extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2040615024448595337L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CustomerBalance\",\"namespace\":\"com.ibm.kafka.streams.assigment\",\"fields\":[{\"name\":\"accountId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"customerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"phoneNumber\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"balance\",\"type\":\"float\"}]}");
   ...
   */
  public static com.ibm.kafka.streams.assigment.CustomerBalance.Builder newBuilder() {
    return new com.ibm.kafka.streams.assigment.CustomerBalance.Builder();
  }
   ...
   * @return A new CustomerBalance RecordBuilder
   */
  public static com.ibm.kafka.streams.assigment.CustomerBalance.Builder newBuilder(com.ibm.kafka.streams.assigment.CustomerBalance.Builder other) {
    if (other == null) {
      return new com.ibm.kafka.streams.assigment.CustomerBalance.Builder();
    } else {
      return new com.ibm.kafka.streams.assigment.CustomerBalance.Builder(other);
    }
  }
   ...
   * @return A new CustomerBalance RecordBuilder
   */
  public static com.ibm.kafka.streams.assigment.CustomerBalance.Builder newBuilder(com.ibm.kafka.streams.assigment.CustomerBalance other) {
    if (other == null) {
      return new com.ibm.kafka.streams.assigment.CustomerBalance.Builder();
    } else {
      return new com.ibm.kafka.streams.assigment.CustomerBalance.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerBalance>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ibm.kafka.streams.assigment.CustomerBalance.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ibm.kafka.streams.assigment.CustomerBalance other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.accountId)) {
        this.accountId = data().deepCopy(fields()[0].schema(), other.accountId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.kafka.streams.assigment.CustomerBalance.Builder setAccountId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.kafka.streams.assigment.CustomerBalance.Builder clearAccountId() {
      accountId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.kafka.streams.assigment.CustomerBalance.Builder setCustomerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.kafka.streams.assigment.CustomerBalance.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.kafka.streams.assigment.CustomerBalance.Builder setPhoneNumber(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.kafka.streams.assigment.CustomerBalance.Builder clearPhoneNumber() {
      phoneNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.kafka.streams.assigment.CustomerBalance.Builder setBalance(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.kafka.streams.assigment.CustomerBalance.Builder clearBalance() {
